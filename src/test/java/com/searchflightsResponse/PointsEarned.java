...
public class PointsEarned {
	...
	public String toString() {
		return "PointsEarned [baseRewardPoints=" + baseRewardPoints + ", bonusRewardPoints=" + bonusRewardPoints
				+ ", baseTierPoints=" + baseTierPoints + ", bonusTierPoints=" + bonusTierPoints + ", promoRewards="
				+ promoRewards + ", promoTier=" + promoTier + ", additionalProperties=" + additionalProperties + "]";
	}
